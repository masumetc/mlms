			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-size1: 100% 50%; background-image: url({{ asset('assets/backend/assets/') }}/media/misc/outdoor.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-600px bg-white rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" action="{{ url('password_store') }}" method="get">
                            @csrf
                            @csrf
							<!--begin::Heading-->
							...
							<div class="fv-row mb-7">
								<label class="form-label fw-bolder text-dark fs-6">Six digit Code</label>
								<input class="form-control form-control-lg form-control-solid" type="number" placeholder="" name="code" value="{{ old('code') }}" autocomplete="off" />
                                @error('code')
